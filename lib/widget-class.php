<?php
/**
 * Assign custom widget classes
 * Based on https://wordpress.org/plugins/widget-attributes/
 */

class johnlevy_widget_attributes {
...
add_action( 'widgets_init', array( 'johnlevy_widget_attributes', 'setup' ) );
